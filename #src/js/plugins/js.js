'use strict';
(self.webpackChunksadovskiy_design =
  self.webpackChunksadovskiy_design || []).push([
  [792],
  {
    658: (t, e, s) => {
      var i = s(776);
      function opacityForEachItems(t, e) {
        var s = document.querySelector(t);
        if (s) {
          var a = document.querySelectorAll(e),
            n = Math.floor(s.clientWidth / a[0].offsetWidth),
            r = new IntersectionObserver(
              function (t) {
                t.forEach(function (t) {
                  if (t.isIntersecting && t.boundingClientRect.top > 0) {
                    var e = Array.from(a).indexOf(t.target) % n,
                      s = e > 0 ? 350 * e : 0;
                    (i.A.timeline({ easing: 'easeOutExpo', duration: 250 }).add(
                      {
                        targets: t.target,
                        scale: [0.95, 1],
                        delay: s,
                        ...
                        begin: function begin(t) {
                          t.animatables.forEach(function (t) {
                            t.target.style.transition = 'all 0.3s ease-out';
                          });
                        },
                      }
                    ),
                      (t.target.style.transform = 'scale(0.95)'));
                  }
                  !t.isIntersecting &&
                    t.boundingClientRect.bottom > window.innerHeight &&
                    (0, i.A)({
                      targets: t.target,
                      scale: 0.95,
                      duration: 0,
          ...
          (a.forEach(function (t) {
            ...
            window.addEventListener('resize', function updateElementsPerRow() {
              n = Math.floor(s.clientWidth / a[0].offsetWidth);
            }));
        }
      }
      ...
      function isObject(t) {
        ...
        return (
          ...
          null != t &&
          'Object' ===
            (null == t || null == (e = t.constructor) ? void 0 : e.name)
        );
      }
      function pick(t, e) {
        return Array.isArray(e)
          ? pick(t, (t, s) => e.includes(s))
      ...
      !(function swiperLayout() {
        var t = document.querySelectorAll('._swiper');
        if (t)
          for (var e = 0; e < t.length; e++) {
            var s = t[e];
            if (!s.classList.contains('swiper-build')) {
              var i = s.children;
              if (i)
                for (var a = 0; a < i.length; a++) {
                  i[a].classList.add('swiper-slide');
                }
              var n = s.innerHTML,
      ...
      function objectIncludes(t, e) {
        ...
        if (s && i) {
          ...
          for (a = 0; a < e.length; a++)
            if (!objectIncludes(e[a], t[a])) return !1;
          return !0;
        }
        if (s != i) return !1;
        if (e && t && 'object' == typeof e && 'object' == typeof t) {
          ...
          for (a = 0; a < u.length; a++)
            if (!Object.prototype.hasOwnProperty.call(t, u[a])) return !1;
          for (a = 0; a < u.length; a++)
            if (!objectIncludes(t[u[a]], e[u[a]])) return !1;
          return !0;
        }
        return (
            ...
            : t === Date
              ...
              : t === Number
                ...
                : Array.isArray(t) || t === Array
                  ? IMask.MaskedDynamic
                  : IMask.Masked && t.prototype instanceof IMask.Masked
                    ? t
                    : IMask.Masked && t instanceof IMask.Masked
                      ? t.constructor
                      : t instanceof Function
                        ? IMask.MaskedFunction
                        : (console.warn('Mask not found for mask', t),
                          IMask.Masked);
      }
      function normalizeOpts(t) {
        if (!t) throw new Error('Options in not defined');
        if (IMask.Masked) {
          if (t.prototype instanceof IMask.Masked) return { mask: t };
          const { mask: e, ...s } =
            t instanceof IMask.Masked
              ? { mask: t }
              : isObject(t) && t.mask instanceof IMask.Masked
                ? t
                : {};
          if (e) {
            const t = e.mask;
            return {
              ...pick(e, (t, e) => !e.startsWith('_')),
              mask: e.constructor,
              _mask: t,
              ...s,
            };
        ...
        return isObject(t) ? { ...t } : { mask: t };
      }
      function createMask(t) {
        if (IMask.Masked && t instanceof IMask.Masked) return t;
        const e = normalizeOpts(t),
          s = maskedClass(e.mask);
        if (!s)
          throw new Error(
      ...
      class HTMLMaskElement extends MaskElement {
        ...
        get rootElement() {
          ...
          return null !=
            (t =
              null == (e = (s = this.input).getRootNode) ? void 0 : e.call(s))
            ? t
            : document;
        }
        get isActive() {
      ...
      class InputHistory {
        ...
        push(t) {
          (this.currentIndex < this.states.length - 1 &&
            ...
            this.states.push(t),
            this.states.length > InputHistory.MAX_LENGTH && this.states.shift(),
            (this.currentIndex = this.states.length - 1));
        }
        go(t) {
          return (
      ...
      IMask.InputMask = class InputMask {
        constructor(t, e) {
          ((this.el =
            t instanceof MaskElement
              ? t
              : t.isContentEditable &&
                  'INPUT' !== t.tagName &&
                  'TEXTAREA' !== t.tagName
                ? new HTMLContenteditableMaskElement(t)
                : new HTMLInputMaskElement(t)),
            (this.masked = createMask(e)),
            (this._listeners = {}),
            (this._value = ''),
            (this._unmaskedValue = ''),
            (this._rawInputValue = ''),
        ...
        set mask(t) {
          ...
          if (
            !(t instanceof IMask.Masked) &&
            this.masked.constructor === maskedClass(t)
          )
            return void this.masked.updateOptions({ mask: t });
          const e = t instanceof IMask.Masked ? t : createMask({ mask: t });
        ...
        set value(t) {
          this.value !== t &&
            ((this.masked.value = t), this.updateControl('auto'));
        }
        get unmaskedValue() {
        ...
        alignCursor() {
          this.cursorPos = this.masked.nearestInputPos(
            this.masked.nearestInputPos(this.cursorPos, r)
          );
        }
        alignCursorFriendly() {
        ...
        _onInput(t) {
          ...
          (a !== n && (r = this.masked.nearestInputPos(r, n)),
      ...
      class ChangeDetails {
        static normalize(t) {
          return Array.isArray(t) ? t : [t, new ChangeDetails()];
        }
        constructor(t) {
          Object.assign(
            this,
      ...
      class Masked {
        constructor(t) {
          ((this._value = ''),
            this._update({ ...Masked.DEFAULTS, ...t }),
            (this._initialized = !0));
        }
        updateOptions(t) {
        ...
        extractTail(t, e) {
          return (
            void 0 === t && (t = 0),
            void 0 === e && (e = this.displayValue.length),
            new ContinuousTailDetails(this.extractInput(t, e), t)
          );
        }
        appendTail(t) {
          return (
        ...
        _appendCharRaw(t, e) {
          return t
            ? ((this._value += t),
              new ChangeDetails({ inserted: t, rawInserted: t }))
            : new ChangeDetails();
        }
        _appendChar(t, e, s) {
          void 0 === e && (e = {});
          ...
          if (
            ...
            this.state = i;
            let n = this.pad(e);
            const r = this._appendCharRaw(t, e);
            ((n = n.aggregate(r)),
              r.rawInserted || n.equals(a) ? (a = n) : (this.state = s));
          }
          if (a.inserted) {
            let t,
            ...
            if (n && null != s) {
              ...
              if (
                ((n = i.rawInserted.length === s.toString().length),
                !((n && i.inserted) || 'shift' !== this.overwrite))
              ) {
        ...
        append(t, e, s) {
          ...
          const i = isString(s) ? new ContinuousTailDetails(String(s)) : s;
          let a;
        ...
        doPrepare(t, e) {
          return (
            void 0 === e && (e = {}),
            ChangeDetails.normalize(this.prepare ? this.prepare(t, this, e) : t)
          );
        }
        doPrepareChar(t, e) {
          return (
            void 0 === e && (e = {}),
            ChangeDetails.normalize(
              this.prepareChar ? this.prepareChar(t, this, e) : t
            )
          );
        }
        doValidate(t) {
        ...
        splice(t, e, s, i, a) {
          (void 0 === s && (s = ''),
            ...
            void 0 === a && (a = { input: !0 }));
          const h = t + e,
            d = this.extractTail(h),
            c = !0 === this.eager || 'remove' === this.eager;
          let p;
          c &&
            ((i = (function forceDirection(t) {
              switch (t) {
                case r:
                  return u;
                case o:
            ...
            (p = this.extractInput(0, h, { raw: !0 })));
          let m = t;
          const g = new ChangeDetails();
          if (
            (i !== n &&
              ((m = this.nearestInputPos(t, e > 1 && 0 !== t && !c ? n : i)),
              (g.tailShift = m - t)),
            g.aggregate(this.remove(m)),
            c && i !== n && p === this.rawInputValue)
          )
            if (i === u) {
              let t;
              for (
                ;
                p === this.rawInputValue && (t = this.displayValue.length);

              )
                g.aggregate(new ChangeDetails({ tailShift: -1 })).aggregate(
                  this.remove(t - 1)
                );
            } else i === l && d.unshift();
        ...
        optionsIsChanged(t) {
          return !objectIncludes(this, t);
        }
        typedValueEquals(t) {
          const e = this.typedValue;
          return (
            t === e ||
            (Masked.EMPTY_VALUES.includes(t) &&
              Masked.EMPTY_VALUES.includes(e)) ||
            (!!this.format &&
      ...
      class ChunksTailDetails {
        ...
        appendTo(t) {
          if (!(t instanceof IMask.MaskedPattern)) {
            return new ContinuousTailDetails(this.toString()).appendTo(t);
          }
          const e = new ChangeDetails();
          for (let s = 0; s < this.chunks.length; ++s) {
            ...
            if (
              (null != n &&
                (!a || a.index <= n) &&
                ((i instanceof ChunksTailDetails || t._stops.indexOf(n) >= 0) &&
                  e.aggregate(t._appendPlaceholder(n)),
                (r = i instanceof ChunksTailDetails && t._blocks[n])),
              r)
            ) {
      ...
      class PatternCursor {
        ...
        pushLeftBeforeFilled() {
          return this._pushLeft(() => {
            if (!this.block.isFixed && this.block.value)
              return (
                (this.offset = this.block.nearestInputPos(this.offset, u)),
        ...
        pushLeftBeforeInput() {
          return this._pushLeft(() => {
            if (!this.block.isFixed)
              return (
                (this.offset = this.block.nearestInputPos(this.offset, r)),
                !0
              );
          });
        }
        ...
        pushRightBeforeFilled() {
          return this._pushRight(() => {
            if (!this.block.isFixed && this.block.value)
              return (
                (this.offset = this.block.nearestInputPos(this.offset, l)),
        ...
        pushRightBeforeInput() {
          return this._pushRight(() => {
            if (!this.block.isFixed)
              return (
                (this.offset = this.block.nearestInputPos(this.offset, n)),
                !0
              );
          });
        }
      ...
      class PatternInputDefinition {
        ...
        _appendChar(t, e) {
          ...
          return (
            i.inserted &&
              !1 === this.doValidate(e) &&
              ((i = new ChangeDetails()), (this.masked.state = s)),
            i.inserted ||
              this.isOptional ||
              this.lazy ||
              e.input ||
        ...
        _appendPlaceholder() {
          return this.isFilled || this.isOptional
            ? new ChangeDetails()
            : ((this.isFilled = !0),
              new ChangeDetails({ inserted: this.placeholderChar }));
        }
        _appendEager() {
          return new ChangeDetails();
        }
        ...
        currentMaskFlags(t) {
          ...
          return {
            ...t,
            _beforeTailState:
              (null == t || null == (e = t._beforeTailState)
                ? void 0
                : e.masked) || (null == t ? void 0 : t._beforeTailState),
          };
        }
        pad(t) {
          return new ChangeDetails();
      ...
      IMask.MaskedRegExp = class MaskedRegExp extends Masked {
        updateOptions(t) {
      ...
      class MaskedPattern extends Masked {
        ...
        _rebuildMask() {
          ...
          for (let a = 0; a < e.length; ++a) {
            if (this.blocks) {
              ...
              if (i) {
                const {
                  ...
                  r = null != e ? new IMask.RepeatBlock(n) : createMask(n);
                (r &&
                  (this._blocks.push(r),
                  t && (this.exposeBlock = r),
            ...
            if (n === MaskedPattern.ESCAPE_CHAR) {
              if ((++a, (n = e[a]), !n)) break;
              r = !1;
            }
            const u = r
        ...
        extractTail(t, e) {
          (void 0 === t && (t = 0),
            void 0 === e && (e = this.displayValue.length));
          const s = new ChunksTailDetails();
          return (
            t === e ||
              this._forEachBlocksInRange(t, e, (t, e, i, a) => {
                const n = t.extractTail(i, a);
                ((n.stop = this._findStopBefore(e)),
                  (n.from = this._blockStartPos(e)),
                  n instanceof ChunksTailDetails && (n.blockIndex = e),
                  s.extend(n));
              }),
            s
          );
        ...
        nearestInputPos(t, e) {
          if ((void 0 === e && (e = n), !this._blocks.length)) return 0;
          const s = new PatternCursor(this, t);
          if (e === n)
                ...
                : e === l
                  ...
                  : (s.popState(),
                    s.ok
                      ? s.pos
                      : (s.popState(),
                        s.ok ? s.pos : this.nearestInputPos(t, r))))
            : t;
        }
        totalInputPositions(t, e) {
          (void 0 === t && (t = 0),
      ...
      class MaskedRange extends MaskedPattern {
        ...
        _update(t) {
          ...
          ((n.mask =
            u.slice(0, o).replace(/0/g, '\\0') +
            '0'.repeat(this.maxLength - o)),
            super._update(n));
        }
        get isComplete() {
        ...
        boundaries(t) {
          ...
          return (
            a &&
              ((e = '0'.repeat(i.length) + a), (s = '9'.repeat(i.length) + a)),
      ...
      class MaskedDate extends MaskedPattern {
        static extractPatternOptions(t) {
          ...
          return { ...i, mask: isString(e) ? e : s };
        }
        constructor(t) {
          super(
            MaskedDate.extractPatternOptions({ ...MaskedDate.DEFAULTS, ...t })
          );
        }
        updateOptions(t) {
          super.updateOptions(t);
        ...
        _update(t) {
          ...
          (t.min && (n.Y.from = t.min.getFullYear()),
            ...
            super._update({ ...a, mask: isString(e) ? e : s, blocks: n }));
        }
        doValidate(t) {
          const e = this.date;
          return (
        ...
        optionsIsChanged(t) {
          return super.optionsIsChanged(MaskedDate.extractPatternOptions(t));
        }
      }
      ...
      class MaskedDynamic extends Masked {
        constructor(t) {
          (super({ ...MaskedDynamic.DEFAULTS, ...t }),
          ...
          (super._update(t),
            'mask' in t &&
              ...
              (this.compiledMasks = Array.isArray(t.mask)
                ? t.mask.map((t) => {
                    const { expose: e, ...s } = normalizeOpts(t),
                      i = createMask({
              ...
              (this.currentMask !== u
                ? (this.currentMask.reset(),
                  n &&
                    ...
                    (o.tailShift = this.currentMask.value.length - i.length)),
                  r &&
        ...
        get isComplete() {
          var t;
          return Boolean(
            null == (t = this.currentMask) ? void 0 : t.isComplete
          );
        }
        get isFilled() {
          var t;
        ...
        maskEquals(t) {
          return Array.isArray(t)
            ? this.compiledMasks.every((e, s) => {
                if (!t[s]) return;
                const { mask: i, ...a } = t[s];
                return objectIncludes(e, a) && e.maskEquals(i);
              })
            : super.maskEquals(t);
        }
        typedValueEquals(t) {
            ...
            n = e.compiledMasks.map((n, r) => {
              const o = e.currentMask === n,
                l = o
                  ...
                  : n.nearestInputPos(n.displayValue.length, u);
              return (
                n.rawInputValue !== a
                  ? (n.reset(), n.append(a, { raw: !0 }))
                  : o || n.remove(l),
                ...
                n.appendTail(i),
                {
                  ...
                  totalInputPositions: n.totalInputPositions(
                    0,
                    Math.max(l, n.nearestInputPos(n.displayValue.length, u))
                  ),
                }
              );
            });
      ...
      class MaskedEnum extends MaskedPattern {
        ...
        _appendCharRaw(t, e) {
          void 0 === e && (e = {});
          const s = Math.min(this.nearestInputPos(0, l), this.value.length),
        ...
        remove(t, e) {
          if (
            ...
            return new ChangeDetails();
          const s = Math.min(super.nearestInputPos(0, l), this.value.length);
          let i;
          for (i = t; i >= 0; --i) {
            if (
              this.enum.filter((t) =>
                this.matchValue(t, this.value.slice(s, i), s)
              ).length > 1
            )
              break;
          }
      ...
      var h;
      IMask.MaskedFunction = class MaskedFunction extends Masked {
        updateOptions(t) {
          super.updateOptions(t);
        }
        _update(t) {
      ...
      class MaskedNumber extends Masked {
        ...
        _appendCharRaw(t, e) {
          ...
          (u
            ...
            : ((this._value = a), (r = new ChangeDetails())),
          ...
          switch (e) {
            ...
            case u: {
              ...
              if (s >= 0) {
                ...
                if (t < i || this.value.length <= i || e === u) return s;
              }
              break;
            }
            case o:
        ...
        typedValueEquals(t) {
          return (
            (super.typedValueEquals(t) ||
              (MaskedNumber.EMPTY_VALUES.includes(t) &&
      ...
      function createPipe(t, e, s) {
        (void 0 === e && (e = d.MASKED), void 0 === s && (s = d.MASKED));
        const i = createMask(t);
        return (t) => i.runIsolated((i) => ((i[e] = t), i[s]));
      }
      ((IMask.PIPE_TYPE = d),
        (IMask.createPipe = createPipe),
        (IMask.pipe = function pipe(t, e, s, i) {
          return createPipe(e, s, i)(t);
        }));
      IMask.RepeatBlock = class RepeatBlock extends MaskedPattern {
        get repeatFrom() {
          var t;
          return null !=
        ...
        _update(t) {
          var e, s, i;
          const { repeat: a, ...n } = normalizeOpts(t);
          this._blockOpts = Object.assign({}, this._blockOpts, n);
          const r = createMask(this._blockOpts);
          ((this.repeat =
            null !=
            (e = null != (s = null != a ? a : r.repeat) ? s : this.repeat)
              ? e
              : 1 / 0),
            super._update({
              mask: 'm'.repeat(
        ...
        _appendCharRaw(t, e) {
          ...
          for (
            ...
            (u =
              null != (n = this._blocks[l])
                ? n
                : (o = !o && this._allocateBlock(l)));
            ++l
          ) {
            var i, a, n, r;
        ...
        _trimEmptyTail(t, e) {
          ...
          let n;
          (null != e &&
            (n = null == (i = this._mapPosToBlock(e)) ? void 0 : i.index),
            null == n && (n = this._blocks.length - 1));
          let r = 0;
          for (let t = n; a <= t && !this._blocks[t].unmaskedValue; --t, ++r);
          r &&
            (this._blocks.splice(n - r + 1, r),
            (this.mask = this.mask.slice(r)));
        }
        reset() {
      ...
      function collapse_defineProperties(t, e) {
        for (var s = 0; s < e.length; s++) {
          var i = e[s];
          ((i.enumerable = i.enumerable || !1),
            (i.configurable = !0),
            'value' in i && (i.writable = !0),
            Object.defineProperty(t, collapse_toPropertyKey(i.key), i));
        }
      }
      function collapse_toPropertyKey(t) {
        var e = (function collapse_toPrimitive(t, e) {
          if ('object' != collapse_typeof(t) || !t) return t;
          var s = t[Symbol.toPrimitive];
          if (void 0 !== s) {
            var i = s.call(t, e || 'default');
            if ('object' != collapse_typeof(i)) return i;
            throw new TypeError('@@toPrimitive must return a primitive value.');
          }
          return ('string' === e ? String : Number)(t);
        })(t, 'string');
        return 'symbol' == collapse_typeof(e) ? e : e + '';
      }
      var c = (function () {
        return (function collapse_createClass(t, e, s) {
          return (
            e && collapse_defineProperties(t.prototype, e),
            s && collapse_defineProperties(t, s),
            Object.defineProperty(t, 'prototype', { writable: !1 }),
            t
          );
        })(
          function ItcCollapse(t) {
            var e =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : 350;
            (!(function collapse_classCallCheck(t, e) {
              if (!(t instanceof e))
          ...
          [
            {
              ...
              value: function show() {
                var t = this._target;
                if (
                  !t.classList.contains('collapsing') &&
                  !t.classList.contains('_show')
                ) {
                  t.classList.remove('_collapse');
            ...
            },
            {
              ...
              value: function toggle() {
                this._target.classList.contains('_show')
                  ? this.hide()
                  : this.show();
              },
            },
      ...
      function toggleSidebarMenu(t) {
        var e = document.querySelector('.page__aside-button');
        t.classList.contains('_open-menu')
          ? (t.classList.add('_close-menu'),
            setTimeout(function () {
              ((e.style.opacity = '1'),
                ...
                t.classList.remove('_open-menu'),
                t.classList.remove('_close-menu'));
            }, 300))
          : ((e.style.opacity = '0'),
            (e.style.transition = 'opacity 0.2s ease-in-out'),
            (e.style.pointerEvents = 'none'),
            t.classList.add('_open-menu'),
            ...
            t.addEventListener(
              ...
              function transitionEndHandler() {
                ((t.style.transition = ''),
                  t.removeEventListener('transitionend', transitionEndHandler));
              },
              { once: !0 }
            ));
      }
          ...
          e.forEach(function (t) {
            ...
            (t.addEventListener('focus', function () {
              ...
              t.addEventListener('blur', function () {
                '+7' === t.value.trim() &&
                  ((t.value = ''), e && e.updateValue(''));
              }));
          });
      }
      (!(function loaded(t) {
        window.onload = function () {
          (document.querySelector(t).classList.add('preloader-remove'),
            document.documentElement.classList.add('loaded'));
        };
      })('.preloader'),
        (function dinamicAdaptive() {
          new ((function () {
            return (function _createClass(t, e, s) {
              return (
              ...
              [
                {
                  ...
                  value: function _init() {
                    var t = this;
                    (this._els.forEach(function (e, s) {
                      t._data[s] = {
                        el: e,
                        ...
                        moves: JSON.parse(
                          e.dataset.moveEl.replaceAll("'", '"')
                        ),
                        state: -1,
                      };
                    }),
                      new ResizeObserver(function (e) {
                        var s = e[0].contentRect.width;
                        t._data.forEach(function (e) {
                          var i = e.state,
                            a = 0,
                            n = 0,
                            r = !1;
                          (e.moves.forEach(function (t, e) {
                            var u = t['bp-min'],
                              o = t['bp-max'];
                            s >= u && void 0 === o && u >= a
                              ? ((i = e), (a = u), (r = !0))
                              : void 0 === u && s < o && (o <= n || 0 === n)
                                ? ((i = e), (n = o), (r = !0))
                                : s >= u &&
                                  s < o &&
                                  ((i = e), (a = u), (n = o), (r = !0));
                ...
                },
                {
                  ...
                  value: function _move(t) {
                    var e = t.el,
                      s = t.state,
                      i = s > -1 ? t.moves[s].index : t.position,
                      a =
                        s > -1
                          ? document.querySelector(t.moves[s].target)
                          : t.parent;
                    i >= a.children.length
                      ? a.append(e)
                      : a.children[i].before(e);
                  },
                },
              ]
            );
        ...
        (function sidebarMenuHandle() {
          var t = document.querySelector('.sidebar-menu'),
            e = document.querySelectorAll('.burger-button'),
            s = document.querySelector('.project__tabs');
          e.forEach(function (e) {
            (e.addEventListener('click', function () {
              e.classList.contains('header__button')
                ? (e.classList.toggle('_open-menu'), toggleSidebarMenu(t))
                : e.classList.contains('tabs-button__button') &&
                  (e.classList.toggle('_open-menu'),
                  s.classList.toggle('_responsive'));
            }),
              window.addEventListener('resize', function () {
                t.classList.contains('_open-menu') &&
                  (document.body.classList.remove('no-scroll'),
                  t.classList.remove('_open-menu'),
                  e.classList.remove('_open-menu'));
              }));
          });
        })(),
            ...
            (0 !== (window.scrollY || document.documentElement.scrollTop) &&
              ...
              (function returnToSavedPosition() {
                0 !== (window.scrollY || document.documentElement.scrollTop)
                  ...
                  : 0 !== t && window.scrollTo({ top: t, behavior: 'smooth' });
              })());
          }),
            window.addEventListener('scroll', function () {
              (window.scrollY || document.documentElement.scrollTop) >
              0.2 * window.innerHeight
                ? e.classList.add('_rotate')
                : e.classList.remove('_rotate');
            }));
        })(),
        (function shadowScrollHeader() {
          var t = function handleScroll() {
            var t = document.querySelector('.page__header'),
              e = document.querySelector('.page__header-project'),
              s = document
                .querySelector('.page__content')
                .getBoundingClientRect().top;
            t
              ? s < -50
                ? t.classList.add('with-shadow')
                : s <= 0 && t.classList.remove('with-shadow')
              : e &&
                (s < -50
                  ? e.classList.add('with-shadow')
                  : s <= 0 && e.classList.remove('with-shadow'));
          };
          return (
        ...
        (function anchorsSmoothScrolling() {
          document.addEventListener('DOMContentLoaded', function () {
            document.querySelectorAll('.anchor-link').forEach(function (t) {
              t.addEventListener('click', function (t) {
                var e = this.getAttribute('href'),
                  s = new URL(e, window.location.href);
                if (s.pathname === window.location.pathname) {
                  t.preventDefault();
                  var i = s.hash.substring(1),
                    a = t.target.closest('.sidebar-menu');
                  if (a && a.classList.contains('_open-menu')) {
                    var n = document.querySelector('.burger-button');
                    (null == n || n.classList.remove('_open-menu'),
                      document.body.classList.remove('no-scroll'),
                      toggleSidebarMenu(a));
                  }
                  !(function scrollToAnchor(t) {
                    ...
                    if (e) {
                      var s = window.innerWidth,
                        i = 88;
                      s <= 768 ? (i = 60) : s <= 1440 && (i = 71);
                      var a =
                        e.getBoundingClientRect().top + window.scrollY - i;
      ...
      var p = document.querySelector('.answers__list'),
        m = document.querySelector('.tabs-button'),
        g = document.querySelector('.seo-block'),
        k = document.querySelector('.services-price'),
        f = document.querySelector('.company-team'),
        _ = document.querySelector('.about-company'),
        v = document.querySelector('.brand-slide'),
        C = document.querySelector('.card-price'),
        y = document.querySelector('.tooltip'),
        E = /Mobi|Android/i.test(navigator.userAgent);
      if (
        (E ||
          (p && opacityForEachItems('.answers__list', '.answers__content'),
          k &&
            opacityForEachItems(
        ...
        C &&
          (function showCard() {
            document
              .querySelectorAll('.services-price__column')
              .forEach(function (t) {
                var e = t.querySelector('.card-price__open-btn'),
                  s = t.querySelector('.card-price__close-btn');
                (e.addEventListener('click', function () {
        ...
        p &&
          (function answersHandler() {
            var t = document.querySelectorAll('.answers__content'),
              e = document.querySelector('.answers__list');
            t.forEach(function (t) {
              t.querySelector('.answers__question').addEventListener(
                'click',
                function () {
                  var i = e.querySelector('._open');
                  (s(t), i && i !== t && s(i));
                }
              );
            });
            var s = function _toggleMenu(t) {
              var e = new c(t.querySelector('._collapse'));
              t.classList.contains('_open')
                ? (t.classList.remove('_open'), e.toggle())
                : (t.classList.add('_open'), e.toggle());
            };
          })(),
        v &&
          (function brandsSlide() {
            ...
            t &&
              new a.A(t, {
                ...
                breakpoints: {
                  200: { spaceBetween: 10, slidesPerView: 2 },
                  376: { spaceBetween: 20, slidesPerView: 2 },
                  490: { spaceBetween: 30, slidesPerView: 3 },
                  768: { spaceBetween: 40, slidesPerView: 4 },
        ...
        m &&
          (function tabsHandler() {
            var t = document.querySelectorAll('.tabs-button__item'),
              e = document.querySelectorAll('.tab-content__items'),
              s = document.querySelector('.project__tabs'),
              a = document.querySelectorAll('.burger-button');
            t.forEach(function (n, r) {
              n.addEventListener('click', function () {
                ...
                (t.forEach(function (t) {
                  ...
                  s.classList.remove('_responsive'),
                  a.forEach(function (t) {
                    t.classList.contains('_open-menu') &&
                      t.classList.remove('_open-menu');
                  }),
                  (function timeLineHeaderItem(t) {
                    i.A.timeline({ duration: 750 }).add(
                      {
                        targets: t,
                        opacity: [0, 1],
                        translateY: [10, 0],
                        ...
                        begin: function begin(t) {
                          t.animatables.forEach(function (t) {
                            t.target.style.transition = 'opacity 0.9s ease-out';
                          });
                        },
                      },
                      50
          ...
          (function addToBlock() {
            document.addEventListener('DOMContentLoaded', function () {
              var t = document.querySelectorAll(
                ...
                e = document.querySelector('.seo-block__button');
              if (e) {
                var s = e.querySelector('span'),
                  i = 5;
                t.forEach(function (t, e) {
                  e >= i && t.classList.add('hidden');
                });
                var a = function updateButtonStyle() {
                  window.innerWidth >= 768 && i % 2 == 0
                    ? e.classList.add('seo-block__button--even')
                    : e.classList.remove('seo-block__button--even');
                };
                (a(),
                  e.addEventListener('click', function () {
                    if (i < t.length) {
                      for (var n = 0; n < 3; n++)
                        i < t.length && (t[i].classList.remove('hidden'), i++);
                      i === t.length &&
                        ((s.textContent = 'РЎРІРµСЂРЅСѓС‚СЊ'),
                        e.classList.add('_rotate-button'));
                    } else
                      (t.forEach(function (t, e) {
                        e >= 5 && t.classList.add('hidden');
                      }),
                        (i = 5),
                        (s.textContent = 'Р§РёС‚Р°С‚СЊ РµС‰С‘'),
                        e.classList.remove('_rotate-button'));
                    a();
                  }));
              }
            });
        ...
        y &&
          (function tooltipHide() {
            document.querySelectorAll('.tooltip__button').forEach(function (t) {
              t.addEventListener('click', function () {
                var e = t.closest('.tooltip');
                (e.classList.toggle('visible'), console.log(e));
              });
            });
          })(),
        E)
      ) {
        var b = document.querySelector('.menu-list__item-menu');
        b.addEventListener('click', function () {
          b.closest('.menu-list__item').classList.toggle('_open');
        });
      }
      document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.order-form').forEach(function (t, e) {
          var s = t.querySelector('.input.name'),
            i = t.querySelector('.input.phone'),
            a = t.querySelector('.checkbox__input'),
            n = t.querySelector('.order-form__button'),
            r = t
              .querySelector('.order-form__button')
              .closest('.order-form__column');
          function animateError(t) {
            var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : {},
              ...
              r = e.pulses,
              u = void 0 === r ? 3 : r,
              o = t.closest('.order-form__column') || t.parentElement;
            if (o) {
              var l = null,
                h = n;
              requestAnimationFrame(function frame(t) {
                ...
                var e = t - l,
                  s = Math.min(e / h, 1),
                  a = Math.abs(Math.sin(s * u * Math.PI)),
                  n = i * a;
                ((o.style.boxShadow = '0 0 '
                  .concat(n, 'px ')
                  .concat(n / 2, 'px rgba(255,0,0,0.6)')),
                  e < h
          ...
          function validateFormFields() {
            var t = s.value.trim(),
              e = i.value.trim(),
              u = t.length >= 3 && 18 === e.length && a.checked;
            return (
              r.classList.toggle('is-disabled', !u),
              (n.disabled = !a.checked),
              u
            );
          }
          [s, i, a, n, r].includes(null) ||
            (s.addEventListener('input', validateFormFields),
            i.addEventListener('input', validateFormFields),
            a.addEventListener('change', validateFormFields),
            validateFormFields(),
            r.addEventListener('click', function (t) {
              r.classList.contains('is-disabled') &&
                (t.preventDefault(),
                console.warn(
                  'вљ пёЏ [Р¤РѕСЂРјР° '.concat(
                    e + 1,
                    '] РќРµРІР°Р»РёРґРЅР°СЏ РїРѕРїС‹С‚РєР° РѕС‚РїСЂР°РІРєРё'
                  )
                ),
                (function showValidationErrors() {
                  (s.value.trim().length < 3 && animateError(s),
                    18 !== i.value.trim().length && animateError(i),
                    a.checked || animateError(a));
                })());
            }),
            n.addEventListener('click', function () {
              if (!n.disabled && !r.classList.contains('is-disabled')) {
                var t = '';
                n && (t = n.getAttribute('goal-name') || '');
                var e = new FormData();
                (e.append('action', 'send_telegram_message'),
                  i && i.value && e.append('phone', i.value.trim()),
                  s && s.value && e.append('name', s.value.trim()),
                  e.append('goalName', t),
                  fetch(localizedVars.ajax_url, {
                    ...
                    .then(function (t) {
                      (alert('Р’Р°С€ Р·Р°РїСЂРѕСЃ РѕС‚РїСЂР°РІР»РµРЅ.'),
                        console.log('РћС‚РІРµС‚ СЃРµСЂРІРµСЂР°:', t),
                        i && (i.value = ''),
                        s && (s.value = ''),
                        a && (a.checked = !1),
                    ...
                    .catch(function (t) {
                      (console.error(
                        'РћС€РёР±РєР° РїСЂРё РѕС‚РїСЂР°РІРєРµ:',
                        t
                      ),
                        alert(
                          'РџСЂРѕРёР·РѕС€Р»Р° РѕС€РёР±РєР° РїСЂРё РѕС‚РїСЂР°РІРєРµ РґР°РЅРЅС‹С….'
                        ));
                    }));
              }
            }));
